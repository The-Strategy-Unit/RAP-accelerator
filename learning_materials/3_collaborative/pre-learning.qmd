...
Below is a sandbox to practice using git.
...
Don't worry if you don't understand everything here.
Using the CLI is more advanced, and you can use version control with Git very effectively without this.
However, as you get more familiar with Git, this would be a useful next step due to the more advanced capabilities available.

To deepen your understanding of the commands provided below, try this [glossary of each `git` command](https://www.gitquest.app/en/git-glossary/) and this [explanation of the `echo` command](https://www.geeksforgeeks.org/linux-unix/echo-command-in-linux-with-examples/).
...
hints: [git status, git checkout -b docs, 'echo "A new line." >> README.md', git diff, git add ., 'git commit -m "Extend the README"', 'git push -u origin docs']
...
seed: |
  git init
  git remote add origin https://github.com/example/analysis
...
tasks:
  ...
  - text: Push your changes to GitHub
    when: ran "git push -u origin docs"
```

### Further adventures with Git

- [Using Git and GitHub](https://the-strategy-unit.github.io/data_science/style/git_and_github.html)
- [How to Use Git and GitHub](https://www.freecodecamp.org/news/guide-to-git-github-for-beginners-and-experienced-devs/)
